      ...
      <div class="row">
        <div class="col-xxl-12">
          <div class="section__title-wrapper-2 text-center mb-40">
            ...
            <h3 class="section__title-2">Contact Us</h3>
          </div>
        </div>
      </div>
      <div class="row">
              ...
              <div class="col-xxl-5 col-xl-5 col-lg-6">
                <div class="portfolio__content-2">
                  ...
                  <div class="vision__list">
                    <h4>Contact US</h4>
                    <p>Connect with Us to Harness the Power of Our Customer Intelligence Platform</p>
                    <p>Have questions? Need help? Get in touch with us by completing the form below. Or you can directly
                      call or drop us an email!</p>
                  </div>
                </div>
              </div>
