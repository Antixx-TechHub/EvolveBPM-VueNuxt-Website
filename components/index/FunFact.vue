<template>
    <section class="counter__area p-relative z-index-1 green-light-bg-4 pt-145 pb-110 fix">
        <div class="counter__border-animation"></div>
        <div class="container">
            <div class="row align-items-top">
                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-7">
                ...
                <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-5">
                    <div class="blog__more-6 text-md-end mb-70">
                        <nuxt-link href="/" class="tp-btn-blue-2 tp-link-btn-3">
                            See all
                            <span>
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-7">
                    <div class="about__list about__list-counter">
                        ...
                        <div class="about__list-item d-flex align-items-start">
                            ...
                            <div class="about__list-content">
                                <p>Alignment with your culture and core values.</p>
                            </div>
                        </div>
                        <div class="about__list-item d-flex align-items-start">
                            <div class="about__list-icon"><span></span></div>
                            <div class="about__list-content">
                                <p>Teams trained to be your extension units with complete visibility and control.</p>
                            </div>
                        </div>
                        <div class="about__list-item d-flex align-items-start">
                            <div class="about__list-icon"><span></span></div>
                        ...
                        <div v-for="(item, i) in counter_data" :key="i"
                            ...
                            <div class="counter__item-7 white-bg mb-30 text-center">
                                <div class="counter__icon-7">
                                    <span>
                                        <img class="counter__icon-7-shape"
                                            src="~/assets/img/counter/7/counter-icon-shape-1.png" alt="counter__icon" />
        ...
        return {
            counter_data: [
                ...
                },
                {
                    ...
                    num: 100,
                    text: "%",
                    title: "Accuracy of lead delivered",
                },
                {
                    icon: `<svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path opacity="0.4"
                    ...
                    num: 95,
                    text: "%",
                    title: "Accuracy of lead mobile delivered",
                },
                {
                    icon: `<svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                    ...
                    num: 50,
                    text: "%",
                    title: "Reduction in sales cycle",
                },
            ],
        };
    },
