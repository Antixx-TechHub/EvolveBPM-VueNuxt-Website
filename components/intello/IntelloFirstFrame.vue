      ...
      <div class="row">
        <div class="col-xxl-12">
          <div class="section__title-wrapper-2 text-center mb-40">
            ...
            <h3 class="section__title-2">Intello - Real-Time Metrics Mastery </h3>
          </div>
        </div>
      </div>
      <div class="row">
              ...
              <div class="col-xxl-5 col-xl-5 col-lg-6">
                <div class="portfolio__content-2">
                  ...
                  <div class="vision__list">
                    <h4>Intello - Real-Time Metrics Mastery </h4>
                    <p>Stay ahead of the curve with Intello, your ultimate companion for real-time insights. Our intuitive platform provides instant access to crucial campaign metrics, empowering you to make informed decisions on the fly. With Intello, you'll never miss a beat, ensuring your campaigns are always optimized for maximum impact and ROI.</p>
                  </div>
                </div>
              </div>
