      ...
      <div class="row">
        <div class="col-xxl-12">
          <div class="section__title-wrapper-2 text-center mb-40">
            ...
            <h3 class="section__title-2">iMedia – Amplifying Digital Dominance</h3>
          </div>
        </div>
      </div>
      <div class="row">
              ...
              <div class="col-xxl-5 col-xl-5 col-lg-6">
                <div class="portfolio__content-2">
                  ...
                  <div class="vision__list">
                    <h4>iMedia – Amplifying Digital Dominance</h4>
                    <p>Elevate your digital dominance with iMedia, the preferred partner for top B2B lead generation agencies and publishing giants worldwide. Our digital services, ranging from programmatic display to LinkedIn and paid social media campaigns, are engineered to drive maximum engagement and ROI. Picture the impact of strategic content creation built upon audience insights and tailored solutions. With iMedia, your brand's social language will resonate louder and clearer, captivating audiences and driving unparalleled growth.</p>
                  </div>
                </div>
              </div>
