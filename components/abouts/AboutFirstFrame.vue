      ...
      <div class="row">
        <div class="col-xxl-12">
          <div class="section__title-wrapper-2 text-center mb-40">
            ...
            <h3 class="section__title-2">About US - Unveiling Prospect Potential</h3>
          </div>
        </div>
      </div>
      <div class="row">
              ...
              <div class="col-xxl-5 col-xl-5 col-lg-6">
                <div class="portfolio__content-2">
                  ...
                  <div class="vision__list">
                    <h4>Our Quality Process</h4>
                    <p>At Evolve Global Corp., we aim to meet the needs and expectations of our customers while being
                      compliant with customer, regulatory, and internal quality requirements.
                      We are committed to meet the highest quality standards for our internal practices and customers.
                      These standards are woven into our organizational KPIs that we continuously review to improve our
                      Quality Management System, which helps us to achieve our goals and objectives, enhance our
                      performance, and exceed industry standards</p>
                  </div>
                </div>
              </div>
