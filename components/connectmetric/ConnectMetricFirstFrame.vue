      ...
      <div class="row">
        <div class="col-xxl-12">
          <div class="section__title-wrapper-2 text-center mb-40">
            ...
            <h3 class="section__title-2">Connect Metrics -Effortless Connection Building</h3>
          </div>
        </div>
      </div>
      <div class="row">
              ...
              <div class="col-xxl-5 col-xl-5 col-lg-6">
                <div class="portfolio__content-2">
                  ...
                  <div class="vision__list">
                    <h4>Connect Metrics -Effortless Connection Building</h4>
                    <p>Forge meaningful connections effortlessly with Connect Metrics, your go-to tool for building rapport with key decision-makers. Our AI-powered platform analyzes shared interests and connections, providing personalized conversation starters that resonate with your prospects. With Connect Metrics, you'll foster deeper relationships and drive more impactful conversations, accelerating your path to revenue growth.</p>
                  </div>
                </div>
              </div>
