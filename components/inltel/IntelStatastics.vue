      ...
      <div class="row">
        <div class="col-xxl-12">
          <div class="section__title-wrapper-2 text-center mb-40">
            ...
            <h3 class="section__title-2">iIntel – Elevating Strategic Insights</h3>
          </div>
        </div>
      </div>
      <div class="row">
              ...
              <div class="col-xxl-5 col-xl-5 col-lg-6">
                <div class="portfolio__content-2">
                  ...
                  <div class="vision__list">
                    <h4>iIntel – Elevating Strategic Insights</h4>
                    <p>At iIntel, we're not just in the business of research; we're in the business of strategic transformation. Designed for discerning B2B lead generation agencies and publishing powerhouses, our research services deliver unparalleled depth and accuracy. Imagine wielding a tool capable of unearthing conversion-ready data with a staggering 70%-90% accuracy rate. With iIntel, you're not just staying ahead of the curve – you're reshaping it to your advantage.</p>
                  </div>
                </div>
              </div>
