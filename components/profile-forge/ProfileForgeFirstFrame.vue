      ...
      <div class="row">
        <div class="col-xxl-12">
          <div class="section__title-wrapper-2 text-center mb-40">
            ...
            <h3 class="section__title-2">Profile Forge - Unveiling Prospect Potential</h3>
          </div>
        </div>
      </div>
      <div class="row">
              ...
              <div class="col-xxl-5 col-xl-5 col-lg-6">
                <div class="portfolio__content-2">
                  ...
                  <div class="vision__list">
                    <h4>Profile Forge - Unveiling Prospect Potential</h4>
                    <p>Unlock the true potential of your prospect universe with Profile Forge, your secret weapon for personalized outreach. By segmenting influencers from decision-makers, Profile Forge enables you to tailor your messaging for maximum effectiveness. Say goodbye to generic outreach and hello to personalized engagement that drives results. With Profile Forge, you'll uncover hidden opportunities and forge stronger connections with your prospects.</p>
                  </div>
                </div>
              </div>
